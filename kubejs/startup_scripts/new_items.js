...
StartupEvents.registry('item', e => {
  ...
  e.create('nugget_steel_cast').tag('tconstruct:casts/multi_use').tag('tconstruct:casts/multi_use/nugget')
  e.create('pick_head_steel_cast').tag('tconstruct:casts/multi_use').tag('tconstruct:casts/multi_use/pick_head')
  e.create('plate_steel_cast').tag('tconstruct:casts/multi_use').tag('tconstruct:casts/multi_use/plate')
